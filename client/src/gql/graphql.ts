...
export type CommunityQuery = { __typename?: 'Query', community?: { __typename?: 'Community', memberCount: number, postCount: number, title: string, created_at: any, owner: { __typename?: 'User', id: string, username: string } } | null };
