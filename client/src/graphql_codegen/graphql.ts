...
export type VoteCommentMutation = { __typename?: 'Mutation', voteComment: { __typename?: 'VoteCommentSuccess', successMsg: string, code: number, comment: { __typename?: 'Comment', body: string, created_at: any, id: string, voteSum: number, voteStatus: VoteStatus, replyCount: number, owner: { __typename?: 'User', id: string, username: string } } } };
...
export type CommentFeedQuery = { __typename?: 'Query', comments: { __typename?: 'CommentConnection', edges: Array<{ __typename?: 'CommentEdge', node: { __typename?: 'Comment', body: string, created_at: any, id: string, voteSum: number, voteStatus: VoteStatus, replyCount: number, owner: { __typename?: 'User', id: string, username: string } } }>, pageInfo: { __typename?: 'PageInfo', endCursor?: string | null, hasNextPage: boolean } } };
